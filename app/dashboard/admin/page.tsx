...
export default async function DashboardPage() {
  const { stats, recentMagang, recentLogbook, dudiWithCount } = await getDashboardData()
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Total Siswa" value={stats.totalSiswa || 0} sub="Seluruh siswa terdaftar" icon={<Users className="text-cyan-500" />} />
        <StatCard title="DUDI Partner" value={stats.totalDudi || 0} sub="Perusahaan mitra" icon={<Building className="text-blue-500" />} />
